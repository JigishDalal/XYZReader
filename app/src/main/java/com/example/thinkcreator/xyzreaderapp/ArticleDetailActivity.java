...
import com.example.thinkcreator.xyzreaderapp.Adapter.ArticleDetailsPagerAdapter;
import com.example.thinkcreator.xyzreaderapp.DataLoader.ArticleLoader;
import com.example.thinkcreator.xyzreaderapp.Ui.SimpleTextSwitcher;
import com.example.thinkcreator.xyzreaderapp.utils.AnimUtil;
import com.example.thinkcreator.xyzreaderapp.utils.AppBarStateChangeListener;
import com.squareup.picasso.Picasso;

public class ArticleDetailActivity extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor>,View.OnClickListener{
        ...
        mPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(final int position) {
                if (mSimpleTextSwitcherToolbarTitle.getAlpha() == 0.0) {
                    ...
                    //set the fab button animation fade and fade out
    ...
    //it will collapesing and then set title changes
